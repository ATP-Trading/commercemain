...
export function AccountShell({ title, path, children }: { title: string; path: string; children: ReactNode }) {
  ...
  return <main dir={ar ? 'rtl' : 'ltr'} className="min-h-screen bg-neutral-950 px-4 py-8 text-white"><div className="mx-auto max-w-4xl space-y-6">
